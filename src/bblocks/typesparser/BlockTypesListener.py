...
class BlockTypesListener(ParseTreeListener):
    ...
    def enterBlock_type_definition(self, ctx:BlockTypesParser.Block_type_definitionContext):
        pass

    # Exit a parse tree produced by BlockTypesParser#block_type_definition.
    def exitBlock_type_definition(self, ctx:BlockTypesParser.Block_type_definitionContext):
        pass
